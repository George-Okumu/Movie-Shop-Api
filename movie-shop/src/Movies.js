                        ...
                        <div className="flex flex-col justify-between mt-4 bg-black/10 bg-blend-multiply rounded-3xl h-80 overflow-hidden bg-cover bg-center px-7 pt-4 pb-6 text-white">
                            ...
                            <div class="bg-gradient-to-r from-black/30 to-transparent -mx-7 -mb-6 px-7 pb-6 pt-2">
                                ...
                                <div className="mt-4 flex space-x-3 items-center">
                                    <a href="#mine" className="px-5 py-2.5 bg-red-600 hover:bg-red-700 rounded-lg text-xs inline-block">Watch</a>
                                    <a href="#thrteen" className="p-2.5 bg-gray-800/80 rounded-lg hover:bg-red-600">
                ...
                <aside className=" w-1/5 py-10 px-10  min-w-min  border-l border-gray-300 dark:border-zinc-700 hidden lg:block ">
                    ...
                    <div className="mt-10">
                        ...
                        <ul className="mt-4 text-gray-400 text-xs space-y-3">
                            ...
                            <li className="pt-1">
                                <a href="#" className="px-5 py-2.5 bg-red-600  hover:bg-red-700 rounded-lg text-center font-medium block text-white">See More</a>
                            </li>
                    ...
                    <div className="mt-10">
                        ...
                        <ul className="mt-4 text-gray-400 text-xs space-y-3">
                            ...
                            <li className="flex space-x-3 ">
                                <img src="https://upload.wikimedia.org/wikipedia/en/8/86/The_Silence_of_the_Lambs_poster.jpg" className="object-cover w-1/3 rounded-md" alt="" />
                                <div className="flex flex-col justify-between  ">
                                    <div className="flex flex-col space-y-1">
