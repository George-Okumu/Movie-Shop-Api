        ...
        <>
            <aside className=" w-1/6 py-10 pl-10  min-w-min  border-r border-gray-300 dark:border-zinc-700  hidden md:block ">
                ...
                <div className="mt-12 flex flex-col gap-y-4  fill-gray-500 text-sm">
                    ...
                    >
                        <a className="flex items-center space-x-2 py-1 dark:text-white borderme font-semibold  border-r-4 border-r-blue-600 pr-20 " href="#">
                            <svg className="h-5 w-5 fillme fill-blue-600 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
